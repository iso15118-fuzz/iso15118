...
from iso15118.pure_evcc.controller.interface import EVControllerInterface
from iso15118.pure_evcc.evcc_config import EVCCConfig
from iso15118.pure_evcc.transport.tcp_client import TCPClient
from iso15118.pure_evcc.transport.udp_client import UDPClient
...
class EVCCCommunicationSession(V2GCommunicationSession):
    ...
    def __init__(
        ...
        from iso15118.pure_evcc.states.sap_states import SupportedAppProtocol
