...
from iso15118.shared_evcc.messages.din_spec.body import Body as BodyDINSPEC
from iso15118.shared_evcc.messages.din_spec.body import BodyBase as BodyBaseDINSPEC
from iso15118.shared_evcc.messages.din_spec.datatypes import FaultCode as FaultCodeDINSPEC
from iso15118.shared_evcc.messages.din_spec.datatypes import (
    Notification as NotificationDINSPEC,
)
from iso15118.shared_evcc.messages.din_spec.header import (
...
from iso15118.shared_evcc.messages.iso15118_2.body import Body, BodyBase
from iso15118.shared_evcc.messages.iso15118_2.datatypes import FaultCode, Notification
from iso15118.shared_evcc.messages.iso15118_2.header import MessageHeader as MessageHeaderV2
...
class State(ABC):
    ...
    def __init__(
        ...
        if timeout > 0:
            ...
            logger.debug(f"Waiting for up to {float(timeout)} s")
